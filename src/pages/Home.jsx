...
// Lazy load de componentes visuales
const ScrollFloat = lazy(() => import("../components/Scroll/ScrollFloat"));
const SplitText = lazy(() => import("../components/Split/SplitText"));
            ...
            <div className="history-text">
              <div className="feature-grid-2">
                ...
                <div className="feature-card-imagen history-images">
                  <OptimizedImage src="/images/camarones _fritos.jpg" alt="Camarones fritos al estilo chino" />
                </div>
                <div className="feature-card-2">
                ...
                <div className="feature-card-imagen history-images">
                  <OptimizedImage src="/images/spareribs.png" alt="spareribs al estilo chino" />
                </div>
                <div className="feature-card-2">
                ...
                <div className="feature-card-imagen history-images">
                  <OptimizedImage src="/images/gado_gado.jpg" alt="Interior del restaurante" />
                </div>
              </div>
            </div>
          </div>
